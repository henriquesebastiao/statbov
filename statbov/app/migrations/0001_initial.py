    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, help_text='M - Masculino | F - Feminino', max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exit_date_batch', models.DateField(blank=True, null=True)),
        ...
        migrations.AddIndex(
            model_name='batchlog',
            index=models.Index(fields=['entry_date_batch'], name='entry_date_batch_idx'),
        ),
        migrations.AddIndex(
            model_name='batchlog',
            index=models.Index(fields=['exit_date_batch'], name='exit_date_batch_idx'),
        ),
